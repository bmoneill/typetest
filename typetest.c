/*
 * typetest.: A simple typing speed test. Not very precise. Prints a
...
/**
 * @brief struct to hold results of the typing test.
 * It contains the number of mistakes, character count, word count,
 * total time taken, and average time per word.
 */
typedef struct {
...
/**
 * @brief replicate the given file line by line, with no time limit.
 *
 * @param fp file to replicate contents of
 * @param r result_t to store results in
 */
